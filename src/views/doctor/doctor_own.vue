<template>
	<div class='top'>
		<el-descriptions class="margin-top" title="医生-我的基本信息" :column="1">
			<template slot="extra">
			...
			<el-descriptions-item label="医生id">{{form.doc_id}}</el-descriptions-item>
		...
		<el-dialog title="修改密码" :visible.sync="dialog2">
			<el-form :model="form">
				<el-form-item label="旧密码" label-width="120px">
					<el-input v-model="docPassword" show-password type="Password"></el-input>
				</el-form-item>
				<el-form-item label="新密码" label-width="120px">
					<el-input v-model="docNewPassword" show-password type="Password"></el-input>
				</el-form-item>
				<el-form-item label="确认密码" label-width="120px">
					<el-input v-model="docNewPassword1" show-password type="Password"></el-input>
				</el-form-item>
			</el-form>
			<div slot="footer" class="dialog-footer">
